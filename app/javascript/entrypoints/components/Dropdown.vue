...
let isShow = ref('hidden');

const btnMenu = () => {
  if (isShow.value === 'hidden') {
    isShow.value = 'block';
  } else {
    isShow.value = 'hidden';
  }
  ...
  <div class="flex justify-center">
    <div class="relative inline-block">
      ...
      >
        ...
        <a
          href="#"
          class="bg-cyan-200 block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
        >
          Sign Out
        </a>
      </div>
